...
<script>
  ...
  <script>
      jQuery(function(){
           var navPos = jQuery('.introduce_shoulder_copy').offset().top;
    
           jQuery(window).scroll(function() {
                 if(jQuery(window).scrollTop() > navPos) {
                         jQuery('.introduce_shoulder_copy').addClass('fixed'); 
                     } else {
                         jQuery('.introduce_shoulder_copy').removeClass('fixed');
                     }
           });
  });
  </script>
  <script>
      jQuery(function(){
           var set_for_navigation2 = jQuery('.introduce_shoulder_copy').offset().top;
    
           jQuery(window).scroll(function() {
                 if(jQuery(window).scrollTop() > set_for_navigation2) {
                         jQuery('.wp_toc1').addClass('fixed1'); 
                     } else {
                         jQuery('.wp_toc1').removeClass('fixed1');
                     }
           });
  });
  </script>
  <script>
      jQuery(function(){
           ...
           jQuery(window).scroll(function() {
                 if(jQuery(window).scrollTop() > set_for_navigation2) {
                         jQuery('.rwp-review-wrap .rwp-review .rwp-users-reviews-wrap .rwp-people-label em a').addClass('fixed2'); 
                     } else {
                         jQuery('.rwp-review-wrap .rwp-review .rwp-users-reviews-wrap .rwp-people-label em a').removeClass('fixed2');
                     }
           });
  });
  </script>
